...
export async function getEthereumTransacion(from, to, amount) {
    ...
    const transaction = { from: from, to: to, data: data, gasLimit: gasLimit, value: value, type: "0x2", chainId: "0x" + chainId.toString(16), maxPriorityFeePerGas: maxPriorityFeePerGasHex, maxFeePerGas: maxFeePerGasHex }
...
export async function getEthereumTransacionLegacy(from, to, amount) {
    ...
    const value = "0x" + BigNumber(amount).toString(16);
    const transaction = { from: from, to: to, data: data, gasLimit: gasLimit, value: value, type: "0x0", chainId: "0x" + chainId.toString(16), gasPrice: maxFeePerGasHex }
