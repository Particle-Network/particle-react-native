...
export default class AuthCoreDemo extends PureComponent<AuthCoreScreenProps> {
  ...
  connect = async () => {
    const jwt =
      'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IndVUE05RHNycml0Sy1jVHE2OWNKcCJ9..kuCyWb6u1Ix67y1FT7U80c-lIlv6LPqnH4PIyn_auppSpJXsQ4svboEUk5NYsWkionaYn90Xh60XgM3lqRJegB84GECu90_ZfWhZ-oVZPn-XRvQS0ygYuyK0p9uZEqHUpJkxjXDc_TOsHUOHTHyhQ4RHN-iyiR3n295YgMbPZydwqmzuqh73EshSQnyBSrVF0geNLEV1AUW64ypoCFscinjEIaxxajQPk8m4IJ4hqeTSXmUF05vYT_XH0oAgvEkZBBfbj6zfFwJCyi4rtSeJ1iS2ljXhW4Jn2w_BJL9wiXAmoTYOP-Tm4hzewxNwHFnod8e6nSY4Ud8EhKir9txdvQ'; // your jwt
