...
export default class Demo extends PureComponent<DemoProps> {
    ...
    init = () => {
        ...
        // init particle auth core
        particleAuthCore.init();

        // init particle wallet 
        particleWallet.initWallet(walletMetaData);

        // set custom UI, ... more method defined in particleWallet.
    ...
    data = [
        ...
        { key: 'SignAndSendTransaction', function: this.solanaSignAndSendTransaction },
    ];
